...
const PageHero = ({ props }) => {
  ...
  return (
    <section className="flex justify-center w-[375px]  md:w-full bg-[--Dark-Violet]">
      <div
        className={`text-white md:flex items-start justify-between flex-row-reverse md:w-5/6 border md:translate-y-[20%] `}
      >
        <div>
        ...
        >
          ...
          <div className="space-y-4 py-[3rem] md:py-0  md:w-[550px]  dmSerif ">
            <div className="mb-[2.5rem] w-[8rem] h-[.04rem] bg-[--Grayish-Blue] hidden md:block mt-[-1.5rem]"></div>
            <h1
