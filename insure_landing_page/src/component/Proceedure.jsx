  ...
  return (
    ...
    >
      <div className="md:mt-[20rem] flex flex-col items-center lg:items-start  md:w-5/6 w-[375px] ">
        ...
        <h1
          className={` first-letter:capitalize font-bold text-[2.5rem] md:text-[4rem] md:text-left text-center text-[--Dark-Violet] mb-[3rem] karla`}
        >
          {title}
        </h1>
        <article
        ...
        >
          <Mapp
            utilis={card}
            styles={`mb-[8rem] space-y-5 flex flex-col items-center text-center md:items-start md:text-left  justify-center`}
            alt={card}
            h1={"text-3xl karla"}
            p={`dmSerif`}
          />
        ...
        <div
          className={`d px-[3rem] text-center gap-y-[2rem] h-[18em] flex flex-col items-center justify-center bg-[--Dark-Violet] text-[--Very-Gray]  md:flex-row w-full md:justify-between md:h-[12rem]`}
        >
          <h1
          ...
          <Btn styles={" btn tracking-widest"} text={navitem[0]} />
        </div>
      </div>
    </section>
  );
